...
/**
 * Семантическая матрица «Светопись Домов».
 * Канонический источник данных. Идентичная копия живёт в web/js/houses.js —
 * при изменении семантики обновляйте оба файла.
 */
...
module.exports = { HOUSES, THEMES, themeForDigit, houseForStep, parseSeed };
